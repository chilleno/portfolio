...
let className = {
  main: {
    dark: "flex xl:flex-row lg:flex-row md:flex-col sm:flex-col w-full justify-center items-center py-28 gap-5",
    light: "flex xl:flex-row lg:flex-row md:flex-col sm:flex-col w-full justify-center items-center py-28 gap-5",
  }
}
